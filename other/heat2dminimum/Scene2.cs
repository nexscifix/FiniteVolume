...
namespace fluidedotnet
{
  ...
  public class Scene
  {
    ...
    public bool drawelementid = false;
    //  public bool   byonestep;
    // public bool   readytostep;    

    public string filename;
    public bool drawgrid = false;
    public bool fillelement = true;
    public bool drawbndfaces = false;
 ...
 */
  ...
  //      p[2] = -1;
    ...
    public void RenderParent(Graphics gdi, int x, int y, double tmax)
    {
        int cellx1 = 0, celly1 = 0, cellx2 = 0, celly2 = 0;
        ...
        cellx1 = (int)(x * fluid.dh * zoom * localzoom); celly1 = (int)(y * fluid.dh * zoom * localzoom); cellx2 = (int)(fluid.dh * zoom * localzoom); celly2 = (int)(fluid.dh * zoom * localzoom);
        double t = fluid.T[x, y];
        if(t<0)
            t=0;
        double tc = t * ValueColorCoeff;// -240 * 3 - 80;
        Brush b = new SolidBrush(ValueToColor((int)tc));
        FillRectangle(gdi, b, cellx1, celly1, cellx2 , celly2 );
